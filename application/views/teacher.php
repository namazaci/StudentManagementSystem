    ...
    <div class="modal-content">
      ...
      <div class="modal-body edit-modal">
        ...
        <div class="tab-content">
          ...
          <form class="form-horizontal" id="updateTeacherPhotoForm" action="teacher/updatePhoto" method="post" enctype="multipart/form-data">
          ...
          <br />
          <form class="form-horizontal" action="teacher/updateInfo" method="post" id="updateTeacherInfoForm">
            <div class="row">
...
<div class="modal fade" tabindex="-1" role="dialog" id="removeTeacherModal">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
       <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
       <h4 class="modal-title" id="myModalLabel">Remove Teacher</h4>
     </div>
       <div class="modal-body">
       ...
       <div class="modal-footer">
         <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
         <button type="submit" class="btn btn-primary" id="removeTeacherBtn">Save changes</button>
       </div>
    </div><!-- /.modal-content -->
  </div><!-- /.modal-dialog -->
</div><!-- /.modal -->
